...
# ╔═╡ 4957f96d-8372-4a64-9ce3-e98a14edd124
using PlutoUI

# ╔═╡ 2b9c5434-f37a-11ef-0a4d-c144b92a180e
using KernelAbstractions

# ╔═╡ b1e1bedc-25f0-48a8-894c-083e439fdb25
using Random

# ╔═╡ e896866b-c2d8-48c4-8c54-349fbe585f75
using CUDA, CUDA.CUDAKernels

# ╔═╡ 7464346d-f30d-4f4c-8845-6825e30ed027
begin
...
# ╔═╡ a5c96e95-c344-44b6-ab57-b895ed00ff1b
md"""
## Generic CPU/GPU programming with `KernelAbstractions.jl`
"""

# ╔═╡ 96ab1867-da54-40d9-ac11-e52f8511b8e8
...
# ╔═╡ 74709854-12b6-4333-8b16-9215870d99b6
...
# ╔═╡ d2e2e708-97f6-4b09-b203-e07a6901b86c
b = randn!(allocate(backend, Float32, size(a, 2), 45));

# ╔═╡ e44d5424-8922-4e13-a9c1-066e353717ed
begin
...
# ╔═╡ 14be2372-9805-445b-a54c-0f32dd57b8a3
output ≈ a * b

# ╔═╡ 4a316863-c30a-4e89-aec6-34294c060747
output
...
manifest_format = "2.0"
project_hash = "a44edf4a6111920cb991787279b714888c104647"
...
deps = ["Artifacts", "JLLWrappers", "LazyArtifacts", "Libdl", "TOML"]
git-tree-sha1 = "545bc98d6abf0019b1554d0ef081a26940a9e328"
uuid = "85f0d8ed-5b39-5caa-b1ae-7472de402361"
version = "0.7.0+0"

[[deps.SPIRV_Tools_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "7124c0656892c25a7bc3289b76eb9766676144ca"
