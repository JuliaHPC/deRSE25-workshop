...
#> [frontmatter]
#> title = "Example: Diffusion kernel with KerneAbstractions"
#> license = "MIT"
#> 
#>     [[frontmatter.author]]
...
# ╔═╡ 4691a2d6-f441-11ef-063a-113ab982ca4c
using PlutoUI

# ╔═╡ 7f98c006-4992-450e-815b-45e715fec680
begin
	using OffsetArrays
	using CairoMakie
end

# ╔═╡ a825ae59-f08f-4c20-9281-33044d4000b5
begin
	# using AMDGPU
	using KernelAbstractions
end

# ╔═╡ 106ca9e0-ac62-4e91-8877-8228cd0ee8fa
@bind backend Select([CPU(),])

# ╔═╡ 3f43fea3-cee6-4367-bb80-640400e2f52a
begin
	a  = 0.01
...
# ╔═╡ 27827622-c8d5-43b8-8260-c8820464bdf6
dt = dx^2 * dy^2 / (2.0 * a * (dx^2 + dy^2)) # Largest stable time step

# ╔═╡ 167cda0b-920f-4f10-a3f5-0d12794e1041
N = 64

# ╔═╡ 39dc421a-2773-4b44-b757-727c71beeb80
...
# ╔═╡ 80f03587-1765-48d3-8e9f-dbe08041ced0
...
# ╔═╡ fa95d6a8-0849-4305-b76b-b8244550db6f
let
	xs = 0:(N+1)
	ys = 0:(N+1)
	domain = OffsetArray(
...
manifest_format = "2.0"
project_hash = "8eeefa3cb57f0d1f4052eb955ab499e04ac38433"
