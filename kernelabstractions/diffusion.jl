...
#> [frontmatter]
#> title = "Example: Diffusion kernel with GPUArrays"
#> license = "MIT"
#> 
#>     [[frontmatter.author]]
...
# ╔═╡ 11c91607-507b-4424-a6d9-a3111e2a5c53
using PlutoUI

# ╔═╡ 69a20e84-f430-11ef-38e8-87120a8f5041
begin
	using OffsetArrays
	using CairoMakie
...
# ╔═╡ 11c2921a-905c-4982-b7ba-bb99329bf698
begin
	# using AMDGPU
	using KernelAbstractions
end

# ╔═╡ a299ee1f-e580-47b6-9a0f-7f12a3ca97b4
@bind backend Select([CPU(),])

# ╔═╡ 63673043-a4b3-4304-a163-d910a68e4f21
begin
	a  = 0.01
...
# ╔═╡ a7b3f51a-37ed-4bee-b9fe-9e2b1425ee23
dt = dx^2 * dy^2 / (2.0 * a * (dx^2 + dy^2)) # Largest stable time step

# ╔═╡ 09f19ed8-2ab6-43bc-b0ed-f2c1765ce729
N = 64

# ╔═╡ c1b2eabf-878f-44ac-bd8e-6eac38f6c7b9
...
# ╔═╡ b2a5d29f-bfe4-4f64-aed2-5a3fcc08ff8a
let
	xs = 0:(N+1)
	ys = 0:(N+1)
	domain = OffsetArray(
...
manifest_format = "2.0"
project_hash = "f1ebcf7b5e4cbd459db8a147fb78abf66c92df93"
